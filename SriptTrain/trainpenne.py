...
def main(data_dir, model_name='yolov8n.pt', epochs=70, imgsz=640):
    ...
    results = model.train(
        ...
        # Ottimizzazione (già eccellente precision: 0.990)
        optimizer='AdamW',
        lr0=0.001,
        lrf=0.01,
        momentum=0.937,
        ...
        # Data augmentation moderata (già buone performance)
        hsv_h=0.015,
        hsv_s=0.7,
        hsv_v=0.4,
        degrees=12.0,
    ...
    # Risultati
    print(f"\n📊 Risultati salvati in: ../runs/train/yolo_Pen")
    print(f"📈 mAP50: {results.results_dict.get('metrics/mAP50(B)', 'N/A')}")
    print(f"📈 mAP50-95: {results.results_dict.get('metrics/mAP50-95(B)', 'N/A')}")
    print(f"💾 Best weights: ../runs/train/yolo_Pen/weights/best.pt")
    print(f"💾 Last weights: ../runs/train/yolo_Pen/weights/last.pt")
    ...
    print(f"🎯 Usa il modello: ../runs/train/yolo_Pen/weights/best.pt")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train YOLO on datasetpenne folder")
    parser.add_argument('--data_dir', type=str, default='datasetpenne', help='Path to dataset folder')
