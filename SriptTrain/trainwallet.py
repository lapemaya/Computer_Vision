...
def main(data_dir, model_name='yolov8n.pt', epochs=60, imgsz=640):
    ...
    results = model.train(
        ...
        # Ottimizzazione (già buone performance: 0.881)
        optimizer='AdamW',
        lr0=0.001,
        lrf=0.01,
        momentum=0.937,
    ...
    # Risultati
    print(f"\n📊 Risultati salvati in: ../runs/train/yolo_Wallet")
    print(f"📈 mAP50: {results.results_dict.get('metrics/mAP50(B)', 'N/A')}")
    print(f"📈 mAP50-95: {results.results_dict.get('metrics/mAP50-95(B)', 'N/A')}")
    print(f"💾 Best weights: ../runs/train/yolo_Wallet/weights/best.pt")
    print(f"💾 Last weights: ../runs/train/yolo_Wallet/weights/last.pt")
    ...
    print(f"🎯 Usa il modello: ../runs/train/yolo_Wallet/weights/best.pt")

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train YOLO on datasetwallet folder")
    parser.add_argument('--data_dir', type=str, default='datasetwallet', help='Path to dataset folder')
