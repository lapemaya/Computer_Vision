...
def segment_video(input_path,prompt_classes, output_dir="runs/World", confidence=0.4,model_path="yolov8x-world.pt"):
    ...
    results = model.predict(
        ...
        vid_stride=2,        # analizza ogni frame
...
if __name__ == "__main__":
    prompt_classes = ["key", "wallet", "Glasses","Pen","computer"]  # esempio di prompt testuale
    segment_video(input_path="video/4obj1.mp4",prompt_classes=prompt_classes,confidence=0.20)